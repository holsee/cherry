...
- [The CLI](/docs/cli/) — all nineteen verbs: flags, envelopes, exit codes.
...
- [Content components](/docs/components/) — figures, video facades, and callouts: syntax, output, and diagnostics.
