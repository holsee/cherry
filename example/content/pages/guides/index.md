---
title: Guides
description: Worked guides for Cherry — from install to deployed site, the authoring loop, the verifier, themes, deploys, scripting, and upgrades.
permalink: /guides/
---
# Guides
...
<li><a href="/guides/agents/">Scripting and agents</a><p>The --json envelope contract, schemas, llms.txt, markdown mirrors — from jq one-liners to the shipped agent skill.</p></li>
