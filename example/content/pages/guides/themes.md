...
Two ship built-in: `default` (typography-first, Charter serif, quiet) and `cherrybomb` (the brand: neon night wall by dark, poster paper by day — the one this site wears). Inspect any theme's full API:
