...
<picture><source srcset="/images/themes/porcelain-dark.png" media="(prefers-color-scheme: dark)"><img src="/images/themes/porcelain-light.png" alt="The porcelain theme home page" width="1200" height="750"></picture>
<p class="theme-hero-actions"><a class="button" href="/t/porcelain/">Live demo</a></p>
</figure>

Like every official theme in [the gallery](/themes/), porcelain implements theme contract 1.1: every colour flows through the tokens below, the stylesheet lives in the `theme` cascade layer so your unlayered overrides always win, and any template it does not ship falls back to the default theme's copy.
